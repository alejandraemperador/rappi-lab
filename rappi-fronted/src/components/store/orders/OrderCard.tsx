        ...
        <div className="bg-white rounded-[35px] p-8 shadow-sm border border-gray-50 flex flex-col md:flex-row gap-8 transition-all hover:shadow-md">
            ...
            <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <span className={`ml-auto px-4 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest ${getStatusStyles()}`}>
                        {order.status}
                    </span>
                </div>
                ...
                <div className="space-y-2">
                    {order.items?.map((item: any, idx: number) => (
                        <div
                            key={idx}
                            className="flex justify-between items-center bg-gray-50/50 p-3 rounded-2xl border border-gray-50"
                        >
